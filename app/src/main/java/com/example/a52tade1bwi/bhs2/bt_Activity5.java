...
public class bt_Activity5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bt_layout5);
    ...
    public void empfangen(View view) {
        ...
        try {
            if (stream_in.available() > 0) {
                ...
                if(msg.toString().equals("Tuer_auf")){
                    Intent inten = new Intent(bt_Activity5.this, bt_Activity6.class);
                    startActivity(inten);
                }
